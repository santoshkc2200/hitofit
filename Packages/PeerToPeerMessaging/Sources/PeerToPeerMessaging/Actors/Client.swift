            ...
            .run { endpoints in
                ...
                for endpoint in endpoints {
                    ...
                    if textRecord[NetworkServiceConstants.deviceIdentifier] == id {
                        ...
                        self.logger.log("Found endpoint: \(endpoint), but it did not have the correct identifier. id: \(textRecord[NetworkServiceConstants.deviceIdentifier] ?? "nil"), expected: \(id) and ")
                    }
                }
                // Continue browsing.
                return .continue
